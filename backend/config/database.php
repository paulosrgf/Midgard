    ...
    */
    ...
    'connections' => [
       ...
       'pgsql' => [
            ...
            'database' => ltrim(parse_url(env('DATABASE_URL', ''), PHP_URL_PATH), '/') ?: env('DB_DATABASE', 'postgres'),
            'username' => parse_url(env('DATABASE_URL', ''), PHP_URL_USER) ?: env('DB_USERNAME', 'postgres'),
